...
def vision_prompt() -> str:
    return (
        ...
        "orientation_raw. Capture explicit orientation legends. When outlet label A or B matches "
        "a legend, copy the label to orientation_raw and the legend direction to orientation. "
        "Capture project references, notes, and observed parts separately. End labels such as G "
